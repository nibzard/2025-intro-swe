...
Rezerviraj.me is a website that allows users to easily and quickly book various appointments and services online.
...
1. **Clone the repository**:
   ```bash
   git clone https://github.com/davids2510/2025-intro-swe.git
   cd 2025-intro-swe/projects/rezerviraj.me-dsiroglavic-mbudimir
   ```
