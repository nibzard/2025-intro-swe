...
**Project:** PC Builder - web application for Build a PC with your available budget.
**Team:** Stipe Barišić & Luka Ćirković
**Status:** In Progress

## 🎯 Project Overview

This is a web application for Build a PC with your available budget.
...
1. **Clone the repository**:
   ```bash
   git clone https://github.com/stipzard/2025-intro-swe.git
   cd 2025-intro-swe/projects/1950-stipebarisic-lukacirkovic
   ```
