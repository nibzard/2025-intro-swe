...
Cilj projekta je razviti jednostavnu aplikaciju:
        1. Testiranje funkcionalnosti pomoću Behavior Driven Development (BDD) pristupa
        2. Učitavanje ili fotografiranje računa
        3. Prepoznavanje sadržaja pomoću OCR-a
        4. Izdvajanje važnih informacija (proizvod,datum, iznos, trgovina)
        5. Spremanje podataka u CSV datoteku radi lakšeg pregleda i analize
